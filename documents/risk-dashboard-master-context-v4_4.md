# Risk Dashboard — Master Context (v4.4)
...
**Completed in 4.4:** Research screenshot/image input (multimodal transcription → same pipeline, up to 4 images, transcript shown); personalized “What should I focus on?” (dedicated `generateFocus`, profile-fed, allowed-empty, non-duplicative, persisted). Gemini Tier 1 (10k RPD).
